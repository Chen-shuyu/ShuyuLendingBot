# CHANGELOG —— M1～M4 建置期（2026-07-26 ～ 2026-08-15）

> **這份是歷史。** 真金上線之後的變更看 [`../CHANGELOG.md`](../CHANGELOG.md)，
> 現在什麼狀態看 [`../STATUS.md`](../STATUS.md)。
>
> **涵蓋期間**：專案開工到真金上線當天。四個 milestone 的完整變更紀錄
> ——修正致命問題、策略與風控、資料與可觀測、架構重構／測試／部署
> ——以及 2026-08-15 那一則「M4 完成並切換為小額真金運作」的上線紀錄。
>
> **唯一的例外是相對連結路徑**：檔案往下搬了一層，指向主文件的連結補上 `../`，
> 否則會全部斷掉。文字內容一個字都沒改。
