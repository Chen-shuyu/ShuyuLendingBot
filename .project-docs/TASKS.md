...
**狀態（2026-08-22 15:00）**：分支 `feature/measure-actual-hold-time` 完成
**D1 的量測那一半**（見 DECISIONS.md **D040**），測試 524 → **575 項**
（單元＋功能 549、整合 26）全過，並以對照實驗＋真實 DB 副本各驗收一次。
**尚未開 PR。**
...
| 4 | **M1 市場資料落地** | 08-18／08-19 兩次最有資訊量的觀測都只留下幾行日誌 |
| 5 | **P2-2 `earnings_daily` 接資料源** | 六筆部位跑完了還是答不出「賺了多少」 |
