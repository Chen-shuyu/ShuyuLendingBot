...
| D063 | **所有樣本都是模型自己選出來的**，所以量再久也不會有新資訊 | 🔴 **D045／D047／D058 三者共同的上游病因**。12 個等待樣本 10 個擠在 8.76～9.50%；M1-c 長了 187 列而 **186 列 `hold_matched`（零資訊）**。決定：**加入探索**＋**M1-c 換問題**；🔴 **甲-2 因此要排在探索之後** |
